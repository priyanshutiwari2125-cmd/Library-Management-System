<%@ Page Title="Edit Student" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditStudent.aspx.cs" Inherits="LibraryManagementSystem.EditStudent" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h4 class="fw-bold text-dark mb-1"><i class="fa-solid fa-user-pen text-success me-2"></i> Update Student Details</h4>
            <p class="text-muted small mb-0">Modify student information and contact details</p>
        </div>
        <div>
        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-lg-8">
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <asp:TextBox ID="txtEnrollmentNo" runat="server" CssClass="form-control form-control-custom" required="required"></asp:TextBox>
                    </div>

                    <div class="col-12 col-md-6">
                        <label for="txtFullName" class="form-label fw-semibold small text-secondary">Full Name <span class="text-danger">*</span></label>
                        <asp:TextBox ID="txtFullName" runat="server" CssClass="form-control form-control-custom" required="required"></asp:TextBox>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <asp:TextBox ID="txtEmail" runat="server" TextMode="Email" CssClass="form-control form-control-custom" required="required"></asp:TextBox>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <asp:TextBox ID="txtAddress" runat="server" TextMode="MultiLine" Rows="3" CssClass="form-control form-control-custom"></asp:TextBox>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-lg-4 border-start border-light-subtle">
                <div class="text-center p-3">
                    ...
                    <div class="mb-3">
                        <asp:Image ID="imgCurrentPhoto" runat="server" CssClass="img-fluid rounded-circle shadow-sm border" Style="width: 150px; height: 150px; object-fit: cover;" ImageUrl="https://via.placeholder.com/150x150/4f46e5/ffffff?text=User" ClientIDMode="Static" />
                    </div>

                    <div class="mb-3">
                        <asp:FileUpload ID="fuPhoto" runat="server" CssClass="form-control form-control-sm" onchange="previewUploadedImage(this, 'imgCurrentPhoto');" />
            ...
            <div class="col-12 pt-3 border-top d-flex gap-2">
                <asp:Button ID="btnUpdateStudent" runat="server" Text="Update Student Details" CssClass="btn btn-primary-custom px-4" OnClick="btnUpdateStudent_Click" />
